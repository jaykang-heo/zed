...
> **Preview:** The `:bd[elete]` command is available in Zed Preview. It closes the active item in all panes where it appears. If a file is open in multiple panes, all instances will be closed. Use `:bd[elete]!` to also close pinned items.
