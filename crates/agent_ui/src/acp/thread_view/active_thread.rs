...
impl AcpThreadView {
    ...
    fn authorize_pending_with_granularity(
        ...
        self.authorize_with_granularity(tool_call_id, is_allow, window, cx)
    }
...
impl AcpThreadView {
    ...
    fn render_permission_buttons(
        ...
        match options {
            ...
            PermissionOptions::Dropdown(choices) => {
                self.render_permission_buttons_dropdown(choices, entry_ix, tool_call_id, cx)
            }
            PermissionOptions::DropdownWithPatterns {
                choices,
                command_patterns,
    ...
    fn render_subagent_permission_buttons(
        ...
        match options {
            ...
            PermissionOptions::DropdownWithPatterns { choices, .. } => self
                .render_subagent_permission_buttons_dropdown(
                    entry_ix,
                    context_ix,
                    subagent_thread,
